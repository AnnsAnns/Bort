...
EDIT: No. At least not in the ways described here. AtProto/Blueskys Federation and Moderation system have developed in a vastly different way than anticipated and are not similar at all at this point. This doesn't mean that some of the things said here aren't true but in general I'd mark this blog post as incorrect or at least heavily outdated.
