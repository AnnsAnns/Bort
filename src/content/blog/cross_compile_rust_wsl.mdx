...
legacy: true
sideVideo: 'https://www.youtube.com/watch?v=yoC9P8Bsa_k'
---

import logo from './resources/rustlogo.png'
import neofetch from './resources/neofetch.png'
import { Image } from 'astro:assets'

{
    <Image src={logo} alt="🦀🦀🦀 Rust logo"/>
}
...
{
    <Image src={neofetch} alt="Neofetch showing that I run Arch" />
}
