...
import compare from './resources/compare.jpg'
...
{
    <Image src={compare} alt="The Longan Nano, Raspberry Pi Pico and a pen for scale."/>
}
...
{
    <Image src={meme} alt="btw I use arch meme"/>
}
