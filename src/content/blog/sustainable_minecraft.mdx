...
**EDIT: Since 1.21 you don't actually need something like this anymore (unless you want to free up reserved RAM). Minecraft now actually properly handles idle states (no players) and drastically reduces cpu consumption by default.**
