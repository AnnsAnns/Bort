...
legacy: true
sideVideo: 'https://www.youtube.com/watch?v=WW--iJYcZNE'
---

import { Image } from 'astro:assets'

import logoben from './resources/logoben.png'

{
    <Image src={logoben} alt="His Logo" />
}
...
{
    <iframe width="560" height="315" src="https://www.youtube.com/embed/WW--iJYcZNE" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
}

*One of his most watched covers, the entire soundtrack of Donkey Kong Country 2.*
...
{
    <iframe width="560" height="315" src="https://www.youtube.com/embed/d52lY-NRc9Y" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
}

*The Kitchen theme, one of over 30 different songs in the OST playlist*
...
{<iframe width="560" height="315" src="https://www.youtube.com/embed/CAdh7wAR5PA" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>}
*His most popular cover with over 400,000 views on YouTube*
...
{<iframe width="560" height="315" src="https://www.youtube.com/embed/U7Ave_T0RFU" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>}
*And lastly, Plants Vs Zombies, just because I really like the song ;)*
